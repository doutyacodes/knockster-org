      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Manage visitor access and security levels
          </p>
        </div>
        <button
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2 text-slate-600 text-sm">
                          ...
                          />
                          <span>
                            {new Date(invite.validFrom).toLocaleDateString()}
                          </span>
                        </div>
                        <p className="text-xs text-slate-400 mt-1">
                          {new Date(invite.validFrom).toLocaleTimeString([], {
                            hour: "2-digit",
                            minute: "2-digit",
                          })}{" "}
                          -
                          {new Date(invite.validTo).toLocaleTimeString([], {
                            hour: "2-digit",
                            minute: "2-digit",
                          })}
                        </p>
                        ...
                        <span
                          className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-semibold ${
                            invite.status === InvitationStatus.ACTIVE
                              ...
                              : invite.status === InvitationStatus.UPCOMING
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                    {Object.entries(SECURITY_INFO).map(([key, value]) => (
                      ...
                      >
                        <span
                          className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${value.color}`}
                        >
                          {key}
                        </span>
