      ...
      <div className="flex items-center gap-3 md:gap-6">
        ...
        <div className="flex items-center gap-3 cursor-pointer group">
          <div className="text-right hidden sm:block">
            <p className="text-sm font-semibold text-slate-900 group-hover:text-blue-600 transition-colors">Alex Rivers</p>
            <p className="text-[10px] font-medium text-slate-500 uppercase tracking-widest">Org Admin</p>
          </div>
          <img 
